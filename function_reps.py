...
class MetaSGDLrs(hk.Module):
  ...
  def __init__(self,
    ...
    self.meta_sgd_lrs = hk.get_parameter(
        ...
        init=hk.initializers.RandomUniform(*self.lrs_init_range))  #通过均匀分布初始化的学习率数组
